...
# Copied from IPython 3.0.0 to get around loading the whole of nbconvert
# (imports mistune, etc) and to add docx support
...
def pandoc(source, fmt, to, extra_args=None, encoding='utf-8', outputfilename=None):
    ...
    if outputfilename:
        cmd.extend(["-o", outputfilename])

    needs_fileoutput = ["docx"]
    if to in needs_fileoutput:
        if not outputfilename:
            raise Exception("Need to supply a output filename for output format %s!", to)
